document.addEventListener('DOMContentLoaded', function () {
  const productContainer = document.getElementById('product-list-NEWB');
  let allProducts = [];

  fetch('collection/NEWB/NEWB.json')
    .then(res => res.json())
    .then(data => {
  ...
  window.showNewBDetail = function (index) {
  ...
  window.addNewBToCart = function (index) {
    const product = allProducts[index];
